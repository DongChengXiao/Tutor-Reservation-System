...
public class Lesson {
	...
	public Time getOrderStrattime() {
		return OrderStrattime;
	}
	public void setOrderStrattime(Time orderStrattime) {
		OrderStrattime = orderStrattime;
	}
